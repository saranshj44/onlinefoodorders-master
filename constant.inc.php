<?php
define('SITE_NAME','Good Food Admin');
define('FRONT_SITE_NAME','Good Food');

define('FRONT_SITE_PATH','http://localhost/onlinefoodorders-master/');
define('SERVER_IMAGE',$_SERVER['DOCUMENT_ROOT']."onlinefoodorders-master/");
